    ...
    <div className="min-h-screen bg-[#080808]">
      ...
      <main className="pt-16 flex items-center justify-center min-h-screen px-4">
        <div className="w-full max-w-[440px] bg-[#0d0d0d] border border-[#1a1a1a] rounded-lg p-8 animate-fade-in-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-[#0d0d0d] border border-[#1a1a1a] rounded-md px-4 py-3 text-white placeholder:text-[#444444] focus:border-[#00D4FF] focus:outline-none transition-colors"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="********"
                  className="w-full bg-[#0d0d0d] border border-[#1a1a1a] rounded-md px-4 py-3 pr-12 text-white placeholder:text-[#444444] focus:border-[#00D4FF] focus:outline-none transition-colors"
                />
                <button
                  type="button"
          ...
          <button
            type="button"
            className="w-full flex items-center justify-center gap-3 bg-transparent border border-[#1a1a1a] text-white font-medium py-3 rounded-md hover:bg-[#1a1a1a]/50 transition-colors"
          >
            <GoogleIcon />
